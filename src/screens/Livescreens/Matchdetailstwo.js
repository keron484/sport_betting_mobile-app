...
function MatchdetailsTwo({route}){
    const data = [
        {
          id:1,
       ...
       <View style={styles.container}>
         <View style={styles.childone}>
           <View style={styles.title_box}>
              ...
              <Text style={styles.lable}>{league_title}</Text>
              <Text></Text>
           </View>
...
export default MatchdetailsTwo;