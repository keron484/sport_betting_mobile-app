...
const placebetSlice = createSlice({
        ...
        messages:[
            {
                id:1,
                title:"Free Bet Gift",
                body:"Dear customer you have earned a free bet you can check the promo code the the promo code from the promo code section thanks for your loyalty"
            }
        ],
        promo_code:[
             { 
    ...
    reducers:{
        ...
        validateSlipWin(state, action){
          ...
          const exhistingItem = state.events_list.find((items) => items.id === newItems.id);
          if(exhistingItem){
