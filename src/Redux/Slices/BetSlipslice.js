...
const slipslice = createSlice({
     ...
     reducers:{
        ...
        togglePromo(state){
         state.toggle.promoslip = true;
         state.toggle.betslip = false;
         state.toggle.bonus = false;

        },
        toggleBonus(state){
         state.toggle.bonus = true;
         state.toggle.promoslip = false;
         state.toggle.betslip = false;
        },
        togglebetslip(state){
         state.toggle.betslip = true;
         state.toggle.bonus = false;
         state.toggle.promoslip = false;
        }
     }
})
export const slides = (state) => state.betslip.toggle
